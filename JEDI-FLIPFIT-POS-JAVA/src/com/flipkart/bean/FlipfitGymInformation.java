...
//  INSERT INTO FlipFit.GymCentre (centreId, ownerId, centreName, gstin, city, capacity, price, isApproved)
   ...
   */
  public FlipfitGymInformation(String gymCentreID, String ownerID, String gymCenterName, String gstin, String city, int capacity, int price, int isApproved) {
   ...
   */
  public FlipfitGymInformation(String gymCentreID, String ownerID, String gymCenterName, String city, int approved) {
      this.gymCentreID = gymCentreID;
      this.ownerID = ownerID;
      this.gymCenterName = gymCenterName;
      this.city = city;
   ...
   * @param price       The price associated with the gym center.
   */
  public FlipfitGymInformation(String gymCentreID, String ownerID, String gymCenterName, String gstin, String city, int capacity, int price) {
      this.gymCentreID = gymCentreID;
      this.ownerID = ownerID;
      this.gymCenterName = gymCenterName;
      this.gstin = gstin;
